<script>
	...
	const PATHS = {
		...
		'map-pin': ['M12 22s-8-4.5-8-11.8A8 8 0 0 1 12 2a8 8 0 0 1 8 8.2c0 7.3-8 11.8-8 11.8Z', 'M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z'],
		...
		'train-front': 'M8 3.1V7a4 4 0 0 0 8 0V3.1M10.88 14.5 8 20M13.12 14.5 16 20M3 7h18M6 17h.01M18 17h.01M5 3h14a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2Z',
		'square': 'M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2Z',
	};

	const raw = PATHS[name] ?? '';
	const paths = $derived(Array.isArray(raw) ? raw : [raw]);
</script>
