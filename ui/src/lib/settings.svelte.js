...
export const PROVIDERS = [
	...
	},
	{
		...
		keyPlaceholder: 'No API key required',
		keyHelp:
			"Run llama.cpp's llama-server locally — free, private, no API key. Start with: llama-server -hf Qwen/Qwen3-8B-GGUF:Q4_K_M --port 3000",
		baseUrl: 'http://localhost:3000/v1',
		models: [{ id: 'Qwen3-8B-Q4_K_M', label: 'Qwen3 8B (Q4_K_M) — active model' }],
	},
	{
		id: 'lm-studio',
		...
		local: true,
		keyPlaceholder: 'No API key required',
		keyHelp: 'Start the local server in LM Studio — models are discovered from port 1234.',
	...
	},
	{
		...
		local: true,
		keyPlaceholder: 'No API key required',
		keyHelp: 'Run LocalAI locally — models are discovered from port 8080.',
	...
	},
	{
		...
		local: true,
		keyPlaceholder: 'No API key required',
		keyHelp: 'Start vLLM with its OpenAI-compatible server — models are discovered from port 8000.',
	...
	},
	{
		...
		local: true,
		keyPlaceholder: 'No API key required',
		keyHelp: "Enable Jan's local API server — models are discovered from port 1337.",
	...
	},
	{
		...
		local: true,
		keyPlaceholder: 'No API key required',
		keyHelp: 'Enable the OpenAI extension — models are discovered from port 5000.',
